"""
Django settings for django_techstore project.
...
INSTALLED_APPS = [
    ...
    'publicidad_ia.apps.PublicidadIaConfig', # <-- Agrega esta línea
    'agromaker_ai',  # <--- AQUÍ ES DONDE DEBES AGREGARLO
]
...
# Archivos subidos por los usuarios (imágenes de productos, etc.)
# --------------------------------------------------------------------------------
MEDIA_URL = '/media/'
...
# --------------------------------------------------------------------------------
# ID para la clave del carrito en la sesión de Django.
# Ayuda a mantener el nombre del carrito consistente en toda la aplicación.
